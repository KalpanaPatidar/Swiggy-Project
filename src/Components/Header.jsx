...
<<<<<<< HEAD
       ...
       Order food & groceries. Discover best restaurants. Swiggy it!
        ...
        <div className="max-w-[70%] container mx-auto flex gap-5 mt-6">
          <input className="bg-white w-[40%] text-xl px-6 py-4 rounded-2xl ml-7" placeholder="Enter your Delivery Location"></input>
           <input className="bg-white w-[55%] text-xl px-6 py-4 rounded-2xl mr-10 " placeholder="Search for restaurant, item or more"></input>
        </div>
